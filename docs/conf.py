...
htmlhelp_basename = 'projecttestdoc'
...
latex_documents = [
  (master_doc, 'projecttest.tex', u'project test Documentation',
...
man_pages = [
    (master_doc, 'projecttest', u'project test Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'projecttest', u'project test Documentation',
   author, 'projecttest', 'One line description of project.',
   'Miscellaneous'),
]
